...
public class PropKit {
    ...
    public static Prop use(String fileName,boolean isReload) {
        return use(fileName, Const.DEFAULT_ENCODING,isReload);
    }
    ...
    public static Prop use(String fileName, String encoding,boolean isReload) {
        Prop result = null;
        if (isReload || result == null) {
            synchronized (map) {
                result = null;
                if (result == null) {
                    result = new Prop(fileName, encoding);
    ...
    public static void update(String filePath, String key, String value){
        //获取绝对路径
        filePath = PropKit.class.getResource("/" + filePath).toString();
        //截掉路径的”file:/“前缀
